    ...
    app.search = (function() {
        ...
        function cacheSelectors() {
            cache = {
                ...
                $totalResult: $(".search--page .total--result")
            };
        }
        ...
        function renderResults(data) {
          var $resultContainer = getActiveContainer();
          var rows = [];
          cache.$totalResult.text(`${Number(data.pagination.totalDocuments)} results`);
          ...
          $resultContainer.find('.panel-footer span.total').html(`Page ${Number(data.pagination.totalPages) > 0 ? data.pagination.currentPage : 0} of ${data.pagination.totalPages}`);
