      ...
      $tabs = [
        ...
        [
          ...
          "children" => [
            ...
            [ "name" => "CHALLENGE (Enjeu)", "slug" => "challenge-enjeu" ],
            [ "name" => "TREND (Tendance)", "slug" => "trend" ],
            [ "name" => "CUSTOMER EXPERIENCE FEEDBACK(Experience Client)", "slug" => "customer-experience-feedbackexperience-client" ],
            [ "name" => "MARKET KNOWLEDGE (Connaissance Marché)", "slug" => "market-knowledge-connaissance-marche" ],
            [ "name" => "WHITEPAPER (Livre Blanc)", "slug" => "whitepaper-livre-blanc" ],
            [ "name" => "JOURNEY (Parcours)", "slug" => "journey-parcours" ]
          ]
        ],
